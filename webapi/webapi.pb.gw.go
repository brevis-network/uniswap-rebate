...
// UnaryRPC     :call UniRebateServer directly.
...
func RegisterUniRebateHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UniRebateServer) error {
	...
	mux.Handle("GET", pattern_UniRebate_NewProof_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_UniRebate_NewProof_0(annotatedContext, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_UniRebate_GetProof_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_UniRebate_GetProof_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
...
// RegisterUniRebateHandlerFromEndpoint is same as RegisterUniRebateHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterUniRebateHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterUniRebateHandler registers the http handlers for service UniRebate to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterUniRebateHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterUniRebateHandlerClient(ctx, mux, NewUniRebateClient(conn))
}

// RegisterUniRebateHandlerClient registers the http handlers for service UniRebate
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "UniRebateClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "UniRebateClient"
...
func RegisterUniRebateHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UniRebateClient) error {
	...
	mux.Handle("GET", pattern_UniRebate_NewProof_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UniRebate_NewProof_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_UniRebate_GetProof_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_UniRebate_GetProof_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
